...
Flask script that auto provisions Arista Cloud Vision Portal
09232016 Initial release. This script will integrate with Arista Cloud Vision Portal and use the restful APIs
...
def show_switch():
    ...
    for item in reply:
        ...
        mac = item.macAddress
        fqdn = item.fqdn
        c_name = item.containerName
        letz = item.configlets
        switch = [ipadress, mac, fqdn, c_name, letz]
